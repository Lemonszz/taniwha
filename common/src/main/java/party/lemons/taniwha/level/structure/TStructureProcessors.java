...
public class TStructureProcessors
{
	...
	public static final RegistrySupplier<StructureProcessorType<SuspiciousBlockProcessor>> SUSPICIOUS_BLOCK_REPLACEMENT = PROCESSOR_TYPES.register(Taniwha.is("suspicious_block_replacement"), ()->()-> SuspiciousBlockProcessor.CODEC);
	public static final RegistrySupplier<StructureProcessorType<IgnoreAirProcessor>> IGNORE_AIR = PROCESSOR_TYPES.register(Taniwha.is("ignore_air"), ()->()-> IgnoreAirProcessor.CODEC);
