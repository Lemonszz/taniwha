...
public class TChestBoat extends TBoat implements HasCustomInventoryScreen, ContainerEntity
{
	...
	public TChestBoat(EntityType<? extends TBoat> entityType, Level level) {
		super(entityType, level);
	}

	public TChestBoat(Level level, double d, double e, double f) {
		this(TEntities.T_CHEST_BOAT.get(), level);
		this.setPos(d, e, f);
		this.xo = d;
		this.yo = e;
		this.zo = f;
