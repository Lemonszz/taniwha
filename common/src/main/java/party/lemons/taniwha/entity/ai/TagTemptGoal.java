...
public class TagTemptGoal extends Goal
{
	...
	public TagTemptGoal(PathfinderMob pathfinderMob, TagKey<Item> tempTag, double speed, boolean canScare) {
		this.mob = pathfinderMob;
		this.speedModifier = speed;
		this.temptTag = tempTag;
	...
	private boolean shouldFollow(LivingEntity livingEntity) {
		return livingEntity.getMainHandItem().is(temptTag) || livingEntity.getOffhandItem().is(temptTag);
	}
